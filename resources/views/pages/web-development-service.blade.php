        ...
        <div class="row">
            <div class="col-md-4 mb-4 wow fadeInLeft">
                <div class="service-box p-4 text-center border rounded wow zoomIn">
                    ...
                    <p>We build custom websites tailored to your business needs, ensuring a unique online presence that
                        stands out.</p>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4 wow fadeInDown">
                <div class="service-box p-4 text-center border rounded wow zoomIn" data-wow-delay="0.2s">
                    ...
                    <p>Our responsive designs ensure your website looks great on all devices, from desktops to smartphones.
                    </p>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4 wow fadeInRight">
                <div class="service-box p-4 text-center border rounded wow zoomIn" data-wow-delay="0.4s">
                    ...
                    <p>We provide robust e-commerce solutions that drive sales and provide a seamless shopping experience
        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="service-box p-4 text-center border rounded wow fadeInLeft">
                    ...
                    <p>Develop powerful web applications that streamline your business processes and provide better user
                        engagement.</p>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="service-box p-4 text-center border rounded wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <p>Our SEO optimization services help your website rank higher in search results, driving more traffic
                        to your site.</p>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="service-box p-4 text-center border rounded wow fadeInRight" data-wow-delay="0.4s">
                    ...
                    <p>We integrate your website with cloud-based services, providing scalable and secure solutions for your
                        business.</p>
                </div>
            </div>
        </div>
