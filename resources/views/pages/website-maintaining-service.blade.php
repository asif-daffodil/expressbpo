...
@section('content')
    ...
    <div class="container my-5">
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">Continuous monitoring and protection to keep your website secure from threats
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">We keep your website up-to-date with the latest software, plugins, and patches
                            to ensure optimal performance.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">Ongoing optimization to ensure your website loads quickly and runs efficiently,
                            providing the best user experience.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">Quick resolution of issues and bugs to minimize downtime and keep your website
                            running smoothly.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">Regular backups and efficient recovery solutions to protect your data and
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="card-text">Our team is available around the clock to assist with any issues or questions
                            you may have.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="text-center mt-5 wow fadeInUp" data-wow-delay="0.4s">
            <p class="lead">Interested in our services? <a href="contact-us.html" class="btn btn-primary">Contact Us
                    Today</a></p>
        </div>
    </div>
@endsection
